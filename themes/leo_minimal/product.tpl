							...
							<div class="box-info-product">
								...
								<div class="box-cart-bottom">
									...
									{if isset($comparator_max_item) && $comparator_max_item}
										<p id="add_to_compare">
											<a class="add_to_compare btn-product" href="{$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}" data-id-product="{$product->id|intval}" title="{l s='Add to Compare' mod='appagebuilder'}">
												<i class="fa fa-retweet"></i> <span>{l s='Add to Compare'}</span>
											</a>
										</p>
									{/if}
