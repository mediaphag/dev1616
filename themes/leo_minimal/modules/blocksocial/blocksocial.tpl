...
<div id="social_block" class="block footer-block">
	 ...
	 <div class="block_content toggle-footer">	 	
		<p class="desc-block block-1">
			{l s='Minimal is one of the largest international fashion companies. It belongs to Inditex, one of the world’s largest distribution groups. ' mod='blocksocial'}
		</p>
		<p class="desc-block block-2">{l s='Follow us :' mod='blocksocial'}</p>
		<ul>
