<?php /* Smarty version Smarty-3.1.19, created on 2020-03-08 05:46:03
         compiled from "/var/www/mediaphag/data/www/dev1616/themes/leo_minimal/modules/appagebuilder/views/templates/hook/product-carousel/ProductOwlCarousel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10564382375e64bedbe71031-85048745%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7516c01a2aa4c275a6f2b9ccf7511db6f05b156' => 
    array (
      0 => '/var/www/mediaphag/data/www/dev1616/themes/leo_minimal/modules/appagebuilder/views/templates/hook/product-carousel/ProductOwlCarousel.tpl',
      1 => 1475557006,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10564382375e64bedbe71031-85048745',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e64bedbf2a6a7_30757753',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e64bedbf2a6a7_30757753')) {function content_5e64bedbf2a6a7_30757753($_smarty_tpl) {?>
...
$(window).load(function(){
	if($('#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['carouselName']->value, ENT_QUOTES, 'UTF-8', true);?>
').parents('.tab-pane').length)
	{		
		if(!$('#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['carouselName']->value, ENT_QUOTES, 'UTF-8', true);?>
').parents('.tab-pane').hasClass('active'))
		{
			var width_owl_active_tab = $('#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['carouselName']->value, ENT_QUOTES, 'UTF-8', true);?>
...
<?php } else { ?>false<?php }?>,
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['itemsdesktopsmall'])) {?>itemsDesktopSmall : [991,<?php echo intval($_smarty_tpl->tpl_vars['formAtts']->value['itemsdesktopsmall']);?>
],<?php }?>
