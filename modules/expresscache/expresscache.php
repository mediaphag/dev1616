...
class Expresscache extends Module
{
    ...
    */
    ...
    public function getContent()
    {
        ...
        $html = '<script src="//cdn.jsdelivr.net/npm/riot@3.6/riot+compiler.min.js"></script>';
        ...
        if (Configuration::get('PS_MULTISHOP_FEATURE_ACTIVE')) {
            ...
            // if(!Module::isEnabled('expresscache')) {
            //     $html.="<p style='text-align:center; color: red'>".$this->l('This module is Disabled for this shop').'</p>';
            // }
        }
        ...
        if (((bool) Tools::isSubmit('submitExpresscache')) == true) {
            ...
            if (!count($this->_postErrors)) { //Validation
                $this->postProcess();
        ...
        $precache_cron_url = $module_url.'expresscache-precache.php'.'?token='.Tools::substr(Tools::encrypt('expresscache/index'), 0, 10).'&id_lang=IDLANG&id_country=IDCOUNTRY&id_currency=IDCURRENCY&num_products=NUMPRODUCTS&id_shop='.$this->context->shop->id;
